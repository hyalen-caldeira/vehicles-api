package us.hyalen.vehicles.service;

import lombok.AllArgsConstructor;
import lombok.Data;
import us.hyalen.vehicles.client.maps.MapsClient;
import us.hyalen.vehicles.client.prices.PriceClient;
import us.hyalen.vehicles.domain.Location;
import us.hyalen.vehicles.domain.car.Car;
import us.hyalen.vehicles.domain.car.CarRepository;
...
public class CarService {
    ...
    public Car findById(Long id) {
        ...
        Car car = repository
                .findById(id)
                .orElseThrow(() -> new CarNotFoundException("Failed to find car with id: " + id));
